...
MANUAL_CUES = {
    ...
    "l20-c-0cdb4dd9a9c6": ("20-4-1.mp3", 50.22, 51.68),
    ...
    # Lessons 25-30 contain a few short fillers, names, or a deliberate pause
    # that ASR drops even though the source recording is complete.
    "l25-c-791637fcfb8b": ("25-4-1.mp3", 265.18, 267.08),
    "l25-c-3fe08d7453eb": ("25-4-1.mp3", 257.47, 257.98),
    "l25-c-f3f5a758039a": ("25-4-1.mp3", 260.55, 261.00),
    "l25-c-4310efc8f83f": ("25-4-1.mp3", 267.23, 269.34),
    "l25-c-5a4a256d8fe6": ("25-4-1.mp3", 271.38, 276.64),
    "l27-c-9910f780cd6f": ("27-4-1.mp3", 228.04, 231.12),
    "l27-c-4598d5c38dda": ("27-4-1.mp3", 244.30, 246.20),
    "l27-c-d337934fa227": ("27-4-1.mp3", 237.29, 239.96),
    "l27-c-b440ab8232bf": ("27-4-1.mp3", 248.45, 250.74),
    "l27-c-31aea5dbde75": ("27-4-1.mp3", 251.10, 253.26),
    "l28-c-ea992a101962": ("28-4-1.mp3", 335.20, 338.70),
    "l29-c-c255a1e7bd6e": ("29-4-1.mp3", 244.64, 246.92),
